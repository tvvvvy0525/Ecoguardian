# 🌲 EcoGuardian 2.0 - 智能森林消防多智能体仿真系统

**EcoGuardian 2.0** 是一个基于 Python (Pygame + NumPy) 开发的高性能多智能体森林消防仿真平台。该系统模拟了复杂的火灾蔓延动力学，并集成 **UGV (地面机器人)**、**UAV (空中无人机)** 和 **SupportBot (补给机器人)** 三种异构智能体，通过 **在线机器学习 (Online ML)**、**遗传算法 (GA)** 和 **自适应 A* 路径规划** 实现高效的分布式协同灭火。
...
* 拥有 **2倍速移动** 能力与 **强力推土机模式** (自动清除路径上的火障)。
...
*(此处建议放三张图：1. 全局运行图 2. 机器人AOE灭火特写 3. SupportBot救援特写)*
...
* **2025-12-24**: 修正 Drone 扫描逻辑，将视野范围校准为  区域。
